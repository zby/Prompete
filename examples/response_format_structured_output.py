...
# OUTPUT
[   Company(name='Aether Innovations', speciality='Sustainable energy solutions', address=Address(street='150 Futura Plaza', city='Metropolis')),
    Company(name='Gastronauts', speciality='Urban dining experiences', address=Address(street='45 Flavor Street', city='Gourmet Grove')),
    Company(name='SereneScape', speciality='Digital wellness', address=Address(street='800 Tranquil Trail', city='Metropolis'))]
