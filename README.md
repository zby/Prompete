...
Prompete is a simple Python SDK for Large Language Models (LLMs),
an extension of LiteLLM.
It integrates LLMEasyTools, and Jinja2 templates to create a flexible system for
managing prompts and chat interactions. The API is loosely inspired by Claudette.
...
structured data, LLMs require both data - the information that it is supposed to 
manipulate and instructions on how to interpret and use that data.
...
code demolish the UX of your average code editor.
